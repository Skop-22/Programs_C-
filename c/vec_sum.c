//mi parte al principio del video
...
void suma(){
 ...
 if((archivo=fopen("Vector.txt","w+"))==NULL)
  ...
  fprintf(archivo, "%s", "\tResultado de la suma del vector 1 mas el vector 2:\n\n");
...
void resta(){
 ...
 if((archivo_2=fopen("vector_2.txt","w+"))==NULL)
  ...
  fprintf(archivo_2, "%s", "\tResultado de la resta del vector 3 menos el vector unitario:\n\n");
...
void modulo(){
 ...
 if((archivo_3=fopen("vector_3.txt","w+"))==NULL)
  ...
  fprintf(archivo_3,"%s", "\tResultado del modulo es: \n\n");
